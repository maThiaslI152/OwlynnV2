...
class TestGraphRouting:
    ...
    def test_scope_clarify_always_goes_to_complex_llm(self):
        from src.agent.core.graph import scope_clarify_next
    ...
    def test_plan_review_approved_goes_to_security(self):
        from src.agent.core.graph import plan_review_next
    ...
    def test_security_next_approved(self):
        from src.agent.core.graph import security_next_step
