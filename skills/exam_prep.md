...
params:
  - name: sections
    ...
    required: false
    default: "3"
tools_used: [read_workspace_file, ask_user, recall_all_memories, create_pdf]
...
3. **Run sections** — Each section: 3–5 questions drawn from source text. Wait for answers before revealing the rubric.
