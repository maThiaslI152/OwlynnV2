...
**Conversation Length:** 12 exchanges (24 messages total) across 5 topics
...
| Category | Avg Score | Min | Max | Trend | Summary Assessment |
|----------|-----------|-----|-----|-------|---------------------|
...
| Turn | Topic | Message Summary | C1 | C2 | C3 | C4 | C5 | C6 | C7 | C8 | Notes / Excerpts |
|------|-------|-----------------|----|----|----|----|----|----|----|----|------------------|
